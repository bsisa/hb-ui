module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: ['src/geoxml.js', 'src/hb5.js', 'src/menu.js','src/acteurCardController.js', 'src/defaultListsController.js', 'src/hbCardContainerDirective.js', 'src/hbCardContainerController.js', 'src/hbConstatCardDirective.js','src/hbConstatCardController.js' ,'src/immeubleCardController.js', 'src/spreadsheetSelect.js'],
