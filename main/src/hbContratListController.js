(function() {
    ...
    angular.module('hb5').controller('HbContratListController', ['$attrs', '$scope', 'GeoxmlService', 'hbQueryService', '$routeParams', '$log', '$filter', '$timeout', 'hbAlertMessages', 'hbUtil', function($attrs, $scope, GeoxmlService, hbQueryService, $routeParams, $log, $filter, $timeout, hbAlertMessages, hbUtil) {
    
    	//$log.debug("    >>>> HbContratListController called...");
