(function () {
     ...
     */
    angular.module('hb5').controller('DeleteConfirmController', ['$scope', '$uibModalInstance',
     ...
     */
    angular.module('hb5').controller('UnsavedWarnDialogController', ['$scope', '$uibModalInstance',
        function ($scope, $uibModalInstance) {
