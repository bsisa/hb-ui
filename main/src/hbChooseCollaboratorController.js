(function() {
	...
	angular.module('hb5').controller(
			'HbChooseCollaboratorController',
			[
					'$scope',
					'$modal',
					'$routeParams',
					...
					function($scope, $modal, $routeParams,
						...
						.then(function(collaboratorActors) {
								$log.debug("    >>>> HbChooseCollaboratorController: loaded callaboratorActors.");
						...
						/**
				         * Modal panel to update an elfin reference with the selection of from a list of collaboratorActors.
				         */
				        $scope.hbChooseCollaborator = function (selected, selectedPathElement) {
				        	
				            var modalInstance = $modal.open({
				                templateUrl: '/assets/views/chooseCollaboratorActor.html',
				                scope: $scope,
				                controller: 'HbChooseCollaboratorModalController',
				                resolve: {
				                	elfins: function () {
				                    	return $scope.collaboratorActors;
				                    },
	...
	angular
		.module('hb5')
		.controller(
				'HbChooseCollaboratorModalController',
				[
						'$scope',
						'$modalInstance',
						'$filter',
